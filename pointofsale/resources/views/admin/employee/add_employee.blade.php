...
@section('content')
    <div class="main-content">
        <div class="row" id="">
            ...
            <div class="col-md-12">
                <form id="employee_form" class="form-horizontal" method="post" action="{{url('save-employee')}}" enctype="multipart/form-data">
                    {{csrf_field()}}
                        ...
                        <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 col-md-9 col-lg-10">
                                            <ul class="list-unstyled avatar-list">
                                                ...
                                                <li>
                                                    <div id="avatar">
                                                        <img style="width: 20%; margin-top:10px;" src="{{asset('public/images/avatar-default.jpg')}}" class="img-polaroid" id="avatar-photo" alt="">
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
                            ...
                            <div class="panel panel-piluku">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        <label for="password" class="col-sm-3 col-md-3 col-lg-2 control-label required">Password:</label>
                                        <div class="col-sm-9 col-md-9 col-lg-10">
                                            <input type="password" name="password" value="" id="password" class="form-control" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="repeat_password" class="col-sm-3 col-md-3 col-lg-2 control-label required">Password Again:</label>
                                        <div class="col-sm-9 col-md-9 col-lg-10">
